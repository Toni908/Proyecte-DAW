...
class CardMunicipio extends Component {
    render() {
        return (
            <Card className={"myCarusel rounded rounded-3 mb-xxl-0 mb-4"}>
                ...
                <section className={"d-flex flex-row justify-content-between px-5 w-100 more-info-card py-3"}>
                    <div className={"text-center"}>
                        <a className={"text-black"} href={"/municipio/"+this.props.municipio.nombre_municipio}><i className="bi bi-geo-alt fs-4" /></a>
                    </div>
                    <div className={"vertical-line"}/>
                    <div className={"text-center"}>
                        <a className={"text-black"} href={"/municipio/"+this.props.municipio.nombre_municipio}><i className="bi bi-eye fs-4"/></a>
                    </div>
                    <div className={"vertical-line"}/>
                    <div className={"text-center"}>
